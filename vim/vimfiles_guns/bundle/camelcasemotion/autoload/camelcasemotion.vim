...
function! s:Move( direction, count, mode )
	...
	if a:direction == 'e'
	    ...
	    " end of ...
	    " number | ACRONYM followed by CamelCase or number | CamelCase | underscore_notation or dashed-word | non-keyword | word
	    call search( '\d\+\|\u\+\ze\%(\u\l\|\d\)\|\u\l\+\|\%(\a\|\d\)\+\ze[_\-]\|\%(\k\@!\S\)\+\|\%(_\@!\k\)\+\>', 'We' )
	    ...
	    " beginning of ...
	    " word | empty line | non-keyword after whitespaces | non-whitespace after word | number | ACRONYM followed by CamelCase or number | CamelCase | underscore or dashed followed by ACRONYM, Camel, lowercase or number
