...
" toggle-align comments
nnoremap <silent> <plug>NERDCommenterToggleAlign :call NERDComment(0, "toggleAlign")<cr>
vnoremap <silent> <plug>NERDCommenterToggleAlign <ESC>:call NERDComment(1, "toggleAlign")<cr>
...
if g:NERDCreateDefaultMappings
    ...
    " call s:CreateMaps('<plug>NERDCommenterToggleAlign','<leader>ct')
