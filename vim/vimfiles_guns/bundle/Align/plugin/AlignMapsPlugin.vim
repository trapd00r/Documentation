...
if !hasmapto('<Plug>AM_Tsp')	 |map <unique> <Leader>Asp		<Plug>AM_Tsp|endif
" if !hasmapto('<Plug>AM_T~')	 |map <unique> <Leader>T~		<Plug>AM_T~|endif
...
" if !hasmapto('<Plug>AM_tab')	|map <unique> <Leader>tab	<Plug>AM_tab|endif
if !hasmapto('<Plug>AM_tml')		|map <unique> <Leader>aml	<Plug>AM_tml|endif
if !hasmapto('<Plug>AM_tsp')		|map <unique> <Leader>asp	<Plug>AM_tsp|endif
if !hasmapto('<Plug>AM_tsq')		|map <unique> <Leader>asq	<Plug>AM_tsq|endif
